$('document').ready(function() {
		...
		for(var i = 0; i < selected.length; i++) {
			...
			if($('input[type=checkbox][name=chbox][value="'+id+'"]').parent().parent().next().data('id') != 'y') {
				if(getViewportWidth() > 420)
					var cont = $("<tr style=\"display:none\" data-id=\"y\"><td></td><td></td><td></td><td>"+text+"</td><td><form method=\"post\" data-saveid=\""+id+"\" name=\""+act+"\"><input type=\"text\" class=\"num\" placeholder=\"Cant.\" /></form></td><td><input type=\"submit\" value=\"Save\" class=\"btn blue save "+act+"\" /></td></tr>");
				else if(getViewportWidth() <= 420 && getViewportWidth() > 370)
					var cont = $("<tr style=\"display:none\" data-id=\"y\"><td></td><td></td><td>"+text+"</td><td></td><td><form method=\"post\" data-saveid=\""+id+"\" name=\""+act+"\"><input type=\"text\" class=\"num\" placeholder=\"Cant.\" /></form></td><td><input type=\"submit\" value=\"Save\" class=\"btn blue save "+act+"\" /></td></tr>");
				else
					var cont = $("<tr style=\"display:none\" data-id=\"y\"><td></td><td></td><td>"+text+"</td><td></td><td><form method=\"post\" data-saveid=\""+id+"\" name=\""+act+"\"><input type=\"text\" class=\"num\" placeholder=\"Cant.\" /></form></td><td></td><td><input type=\"submit\" value=\"Guardar\" class=\"btn blue save "+act+"\" /></td></tr>");
	...
	function check_item(act, t) {
		...
		if($('input[type=checkbox][name=chbox][value="'+id+'"]').parent().parent().next().data('id') != 'y') {
			if(getViewportWidth() > 420)
				var cont = $("<tr style=\"display:none\" data-id=\"y\"><td></td><td></td><td></td><td>"+text+"</td><td><form method=\"post\" data-saveid=\""+id+"\" name=\""+act+"\"><input type=\"text\" class=\"num\" placeholder=\"Cant\" /></form></td><td><input type=\"submit\" value=\"Guardar\" class=\"btn blue save "+act+"\" /></td></tr>");
			else if(getViewportWidth() <= 420 && getViewportWidth() > 370)
				var cont = $("<tr style=\"display:none\" data-id=\"y\"><td></td><td></td><td>"+text+"</td><td><form method=\"post\" data-saveid=\""+id+"\" name=\""+act+"\"><input type=\"text\" class=\"num\" placeholder=\"Cant\" /></form></td><td></td><td><input type=\"submit\" value=\"Guardar\" class=\"btn blue save "+act+"\" /></td></tr>");
			else
				var cont = $("<tr style=\"display:none\" data-id=\"y\"><td></td><td></td><td>"+text+"</td><td><form method=\"post\" data-saveid=\""+id+"\" name=\""+act+"\"><input type=\"text\" class=\"num\" placeholder=\"Cant\" /></form></td><td></td><td><input type=\"submit\" value=\"Guardar\" class=\"btn blue save "+act+"\" /></td></tr>");
			element.after(cont);

...
if(isset($_POST['act'])) {
	...
	if($_POST['act']=='4'){
		...
		if(!isset($_POST['username']) || !isset($_POST['preg_1']) || !isset($_POST['preg_2']))
			die('wrong');
		if( $_POST['username'] == '' || $_POST['preg_1'] == '' || $_POST['preg_2'] == '')
			die('wrong');
		...
		if($_users->user_ask($userid, $username, $preg_1, $preg_2) == true) {
			die('1');
		}
		die('wrong');
	}
...
<body>
	...
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			...
			<h2 class="noborder">Preguntas de Seguridad</h2>
			<span class="downtitle">Responda utilizando palabras sencillas</span>
			<div class="center">
				<div class="form">
					<form method="post" action="" name="invento-settings-ask">
						<div>
						<input type="hidden" name="new-name" class="ni" value="<?php echo $userdata->name; ?>"> 
						</div>
						¿Nombre de su mascota?:<br />
						<div class="ni-cont">
							<input type="text" name="new-ask" class="ni" />
						</div>
						
						¿Color preferido?:<br />
						<div class="ni-cont">
							<input type="text" name="rnew-ask" class="ni" />
						</div>
						<br />
						<input type="submit" name="invento-settings-a" class="ni btn blue" value="Guardar Respuestas" />
						<br />

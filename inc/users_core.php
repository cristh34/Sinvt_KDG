...
class Users {
	...
	public function user_ask($userid, $username, $preg_1, $preg_2){

		$prepared = $this->prepare("INSERT INTO `test_inv`.`invento_question` (`id_user`, `username`, `preg_1`, `preg_2`) VALUES (?, ?, ?, ?)",'user_ask()');
		$this->bind_param($prepared->bind_param('isss', $userid, $username, $preg_1, $preg_2), 'user_ask()');
		$this->execute($prepared, 'user_ask()');
		return true;

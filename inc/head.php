<?php
$_titles = array('','Inicio','Nuevo producto','Productos','Ingresos','Salidas','Logs','Categorías','Nueva categoría','Usuarios','Nuevo usuario','Editar usuario','Configuración','Editar producto','Editar categoría','Detalle de categoría','Detalle del producto','Detalle del usuario','Pagos','Nuevo pago','Editar pagos');
...
switch($_page) {
	...
	case 3: 
		echo '	<script type="text/javascript" src="media/js/items.js"></script>'; break;
	...
	case 6: 
		echo '	<script type="text/javascript" src="media/js/logs.js"></script>'; break;
		echo '	<script type="text/javascript" src="media/js/pay-pro.js"></script>'; break;
	...
	case 19: echo '	<script type="text/javascript" src="media/js/new-pay.js"></script>'; break;
	case 20: echo '	<script type="text/javascript" src="media/js/edit-pay.js"></script>'; break;

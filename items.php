...
<body>
	...
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			<h2>Productos</h2>
			<div id="table-head">
				<a href="print_pdf.php" name="impr" class="btn blue active fright" target="_blank"><i class="fas fa-beer"></i>Imprimir</a>
				...
				<a href="" name="check-in-all" class="btn green disabled fright"><i class="fa fa-arrow-down"></i>Entradas</a>
			</div>
